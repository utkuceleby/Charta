...
internal static class CosNames
{
    ...
    public static readonly CosName Annots = CosName.Get("Annots");
    public static readonly CosName Annot = CosName.Get("Annot");
    public static readonly CosName Link = CosName.Get("Link");
    public static readonly CosName Rect = CosName.Get("Rect");
    public static readonly CosName Border = CosName.Get("Border");
    public static readonly CosName A = CosName.Get("A");
    public static readonly CosName S = CosName.Get("S");
    public static readonly CosName Uri = CosName.Get("URI");
    public static readonly CosName Dest = CosName.Get("Dest");
    public static readonly CosName Names = CosName.Get("Names");
    public static readonly CosName Dests = CosName.Get("Dests");
    public static readonly CosName Outlines = CosName.Get("Outlines");
    public static readonly CosName First = CosName.Get("First");
    public static readonly CosName Last = CosName.Get("Last");
    public static readonly CosName Next = CosName.Get("Next");
    public static readonly CosName Prev = CosName.Get("Prev");
    public static readonly CosName Title = CosName.Get("Title");
    public static readonly CosName Xyz = CosName.Get("XYZ");
    public static readonly CosName Metadata = CosName.Get("Metadata");
    public static readonly CosName Xml = CosName.Get("XML");
    public static readonly CosName Info = CosName.Get("Info");
    public static readonly CosName Author = CosName.Get("Author");
    public static readonly CosName Subject = CosName.Get("Subject");
    public static readonly CosName Keywords = CosName.Get("Keywords");
